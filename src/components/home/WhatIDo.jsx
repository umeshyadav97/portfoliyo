...
import ProfileImage from "../../assets/images/backgrounds/profile-umesh.png";
  ...
  return (
    ...
    >
      <Box>
        ...
        <Typography
          sx={{ color: homeTheme.body, maxWidth: 620, lineHeight: 1.7, mb: 4 }}
        >
      ...
      <Box
        sx={{
          borderRadius: 3,
          p: { xs: 3, sm: 4 },
          background: homeTheme.softPanelGradient,
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 3 }}>
          ...
          <Box>
            ...
            <Typography
              sx={{ color: homeTheme.purple, fontWeight: 800, mt: 0.5 }}
            >
              Frontend Developer
            </Typography>
          </Box>
        ...
        <Stack spacing={2.2}>
          ...
          >
            <MailOutlineIcon
              ...
              fontSize="small"
            />
            dev.umeshyadav97@gmail.com
          </Typography>
          <Typography sx={{ color: homeTheme.ink, pt: 1 }}>
