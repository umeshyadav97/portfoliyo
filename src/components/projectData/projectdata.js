...
export const projectDeatils = [
  ...
  },
  {
    ...
    img: Customer,
    title: "NFX Customer",
    para: "A customer-facing e-commerce experience with product discovery, secure transactions, checkout flows, and responsive customer support touchpoints.",
    tags: ["E-commerce", "Checkout", "Product Listing", "Customer UX"],
  ...
  },
  {
    ...
    img: Simplee,
    title: "Simplee",
    para: "A real-estate investment platform with investor and admin flows, property distribution, sponsorship options, ACH/Wire-style banking, and fund management.",
    tags: ["Real Estate", "Investor Panel", "Banking", "Dashboard"],
